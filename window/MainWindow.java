...
public class MainWindow extends JFrame{
	...
	void Test()
	{
		BaseSort b = new BaseSort(pnImitiate);
        b.InitRandomArray(10);
        
        BaseSort b2 = new BaseSort(pnImitiate);
        b2.InitRandomArray(12);
        
        BaseSort b3 = new BaseSort(pnImitiate);
        b3.InitRandomArray(13);
